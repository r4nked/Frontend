...
const messages: LocaleMessage<VueMessageType> = {
  validationError: {
  ...
  rank: {
    ...
    remaining: 'You’re done! | One choice remaining. | {n} choices remaining.',
    skipToEnd: {
  ...
  home: {
    title: 'Ranked.',
    description:
      'Make a list of things, then let us help you (and others) rank them. Start your list:'
  },
